...
| 1266 | 004, 008, 009, 010 | VIRAC2 | `TABLE_CONSENSUS` | F560W | gc1266, MIRI imaging carried alongside an IFU program (Garcia Marin); four pointings spanning 2.87' about (266.43624, -29.01889). Supplies the FRAME and the anchor only -- MIRI has no table-driven write channel whatever this declares, because `PipelineMIRI.fix_alignment` opens no offsets table. Consensus rather than locked because nothing has been measured for 1266 yet |
| 3571 | 001, 003, 004, 005, 016 | VIRAC2 | `TABLE_CONSENSUS` | F560W | gc3571, MIRI imaging of the CMZ (Yusef-Zadeh); five adjoining tiles (1/2/3/4/6, Tile-5 never delivered) spanning 3.22' about (266.41973, -29.00509). Same reasoning as 1266 above: frame + anchor, no write channel. F560W anchors both because MIRI has one pixel scale, so the choice is which band gives the best-measured consensus, and F560W is closest to VIRAC2's Ks and detects the most stars -- the longer MIRI bands are dust-emission dominated in the CMZ |
